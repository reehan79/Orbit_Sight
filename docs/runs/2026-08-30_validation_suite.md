...
|------|-------|----|----|----|---------|-----|
| 0 | M0_raw_rank | 60.90% | 89.47% | 94.74% | 53.48% | 0.7683 |
| 0 | M1_logistic | 77.44% | 85.71% | 91.73% | 58.40% | 0.8473 |
| 0 | M2a_tree | 79.70% | 93.61% | 95.86% | 68.48% | 0.8833 |
| 0 | M2b_extra_trees | 80.83% | 93.98% | 97.74% | 71.00% | 0.8847 |
| 1 | M0_raw_rank | 79.24% | 86.38% | 89.00% | 64.82% | 0.9100 |
| 1 | M1_logistic | 84.18% | 87.92% | 89.20% | 73.47% | 0.9421 |
| 1 | M2a_tree | 70.27% | 82.68% | 86.67% | 73.01% | 0.8421 |
| 1 | M2b_extra_trees | 88.33% | 90.86% | 91.11% | 80.39% | 0.9773 |
| 2 | M0_raw_rank | 91.26% | 99.05% | 99.56% | 69.37% | 0.9531 |
| 2 | M1_logistic | 98.76% | 99.33% | 99.65% | 78.81% | 0.9930 |
| 2 | M2a_tree | 89.33% | 94.74% | 95.12% | 88.11% | 0.9242 |
| 2 | M2b_extra_trees | 99.30% | 99.78% | 99.81% | 95.61% | 0.9973 |
...
| 4 | M0_raw_rank | 62.19% | 78.65% | 83.74% | 41.86% | 0.7628 |
| 4 | M1_logistic | 76.77% | 87.09% | 91.55% | 60.55% | 0.8793 |
| 4 | M2a_tree | 72.93% | 85.55% | 88.48% | 59.55% | 0.8466 |
| 4 | M2b_extra_trees | 86.22% | 89.00% | 90.93% | 74.45% | 0.9351 |

### Cross-fold mean ± std

| Model | top1_micro | top3_micro | top5_micro | top1_macro | mrr |
|-------|------------|------------|------------|------------|-----|
| M0_raw_rank | 0.655162 ± 0.193727 | 0.851101 ± 0.092585 | 0.894055 ± 0.071022 | 0.538542 ± 0.118645 | 0.787151 ± 0.144139 |
| M1_logistic | 0.758306 ± 0.186742 | 0.848102 ± 0.114863 | 0.896268 ± 0.076745 | 0.628078 ± 0.125984 | 0.845258 ± 0.149087 |
| M2a_tree | 0.732441 ± 0.116583 | 0.889159 ± 0.046264 | 0.920270 ± 0.037280 | 0.687529 ± 0.116407 | 0.843474 ± 0.067929 |
| M2b_extra_trees | 0.845352 ± 0.102224 | 0.931254 ± 0.036987 | 0.951203 ± 0.035562 | 0.772562 ± 0.104687 | 0.918677 ± 0.071228 |
...
| 1 DVX | M0_raw_rank | 22.18% | 52.27% | 63.05% | 35.70% | 0.4688 |
| 1 DVX | M1_logistic | 50.22% | 70.29% | 81.18% | 53.06% | 0.7203 |
| 1 DVX | M2a_tree | 29.96% | 60.00% | 68.55% | 36.98% | 0.5487 |
| 1 DVX | M2b_extra_trees | 49.60% | 68.73% | 77.67% | 46.57% | 0.7071 |
| 2 DAVIS | M0_raw_rank | 86.31% | 94.74% | 96.22% | 67.96% | 0.9289 |
| 2 DAVIS | M1_logistic | 88.38% | 93.35% | 95.03% | 67.47% | 0.9344 |
| 2 DAVIS | M2a_tree | 55.25% | 60.46% | 69.82% | 54.99% | 0.6405 |
| 2 DAVIS | M2b_extra_trees | 84.33% | 91.37% | 93.48% | 64.89% | 0.9052 |

### Cross-fold mean ± std (stress only)

| Model | top1_micro | top3_micro | top5_micro | top1_macro | mrr |
|-------|------------|------------|------------|------------|-----|
| M0_raw_rank | 0.684415 ± 0.329951 | 0.820846 ± 0.211651 | 0.862835 ± 0.164877 | 0.668317 ± 0.249733 | 0.792868 ± 0.230163 |
| M1_logistic | 0.770914 ± 0.190831 | 0.861060 ± 0.111934 | 0.907098 ± 0.067498 | 0.710682 ± 0.163708 | 0.865698 ± 0.102876 |
| M2a_tree | 0.571310 ± 0.229887 | 0.721814 ± 0.169046 | 0.783460 ± 0.129669 | 0.593812 ± 0.203252 | 0.700473 ± 0.154329 |
| M2b_extra_trees | 0.776441 ± 0.207130 | 0.865061 ± 0.129903 | 0.902722 ± 0.092624 | 0.701517 ± 0.217277 | 0.868324 ± 0.119499 |

CSV: `docs/runs/2026-08-30/cross_sensor_cv.csv`

## Mechanical changes made

1. `tests/test_candidate_ranker.py` — expected `fit_rankers` default set updated to `{"M0_raw_rank", "M1_logistic", "M2a_tree", "M2b_extra_trees", "M2_hist_gb"}` to match `DEFAULT_RANKERS` in `src/orbitsight/models/candidate_ranker.py`.  
   Reason: Suite A test failure after models were added upstream; assertion was stale.

No scientific constants or model hyperparameters were changed.
